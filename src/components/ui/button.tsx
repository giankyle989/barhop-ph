...
const variantStyles: Record<ButtonVariant, string> = {
  primary: "bg-neon-purple hover:bg-neon-purple/90 text-white shadow-glow active:shadow-none",
  secondary: "bg-surface-card hover:bg-surface-overlay text-content border border-border hover:border-border-hover",
